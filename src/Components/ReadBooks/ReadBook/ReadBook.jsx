            ...
            <div className="grid grid-cols-12 gap-6 lg:p-5  mt-6 border bg-cyan-100 shadow-xl  hover:border-[#23BE0A] hover:rounded-lg hover:opacity-90">
                ...
                <div className="col-span-12   ">
                    ...
                    <div className="lg:flex  ">
                        <div className="">
                            <img src={image} className="w-full h-full lg:w-[200px] rounded-2xl lg:h-[190px]" alt="" />
                        </div>
                        <div className="ml-10">
                            ...
                            <div className="flex mt-7">
                                ...
                                <p className="ml-8 mt-3 p-2 bg-[#FFAC33] text-[#FFAC33] bg-opacity-25 rounded-lg">Rating: <span className="  font-medium text-[16px] ">{rating}</span></p>
